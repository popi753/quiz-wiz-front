  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex flex-row items-center gap-2">
        <span className="font-semibold text-sm leading-5 text-purple capitalize">
          question-{index + 1}
        </span>
        <hr className="w-4 text-gray-300 -rotate-90" />
        <span className="font-semibold text-sm leading-5  text-orange capitalize">
      ...
      <div className="flex flex-col gap-2">
        {question.answers.map((answer) => (
          <QuizAnswer
            ...
            limit={question.correctAnswers_count}
          />
        ))}
      </div>
    </div>
